...
# -*- coding: utf-8 -*-
#
# double-duty-canvas documentation build configuration file, created by
...
htmlhelp_basename = 'double-duty-canvasdoc'
...
latex_documents = [
    (master_doc, 'double-duty-canvas.tex',
     u'Double Duty Canvas Documentation',
